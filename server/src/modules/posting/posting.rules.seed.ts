...
export const POSTING_RULES: PostingRuleSeed[] = [
  ...
  // ── receivables & payables, Phase 1 — no caller yet ──
  { event: "SUPPLIER_BILL", key: "GOODS", account: "1214" },
  { event: "SUPPLIER_BILL", key: "SERVICE", account: "5129" },
  { event: "SUPPLIER_BILL", key: "VAT", account: "1233" },
  { event: "SUPPLIER_BILL", key: "PAYABLE", account: "2111" },
  { event: "SUPPLIER_PAYMENT", key: "PAYABLE", account: "2111" },
  { event: "SUPPLIER_PAYMENT", key: "BANK", account: "1242" },
  { event: "SUPPLIER_PAYMENT", key: "ADVANCE", account: "1232" },
  { event: "SUPPLIER_CREDIT", key: "PAYABLE", account: "2111" },
  { event: "SUPPLIER_CREDIT", key: "GOODS", account: "1214" },
  { event: "SUPPLIER_CREDIT", key: "DELIVERED", account: "5121" },
  { event: "SUPPLIER_CREDIT", key: "SERVICE", account: "5129" },
  { event: "SUPPLIER_CREDIT", key: "VAT", account: "1233" },
  { event: "INVOICE", key: "RECEIVABLE", account: "1220" },
  { event: "INVOICE", key: "VAT", account: "2150" },
  { event: "INVOICE", key: "UNBILLED", account: "1221" },
  { event: "INVOICE", key: "UNEARNED", account: "2170" },
  { event: "EARNED", key: "UNEARNED", account: "2170" },
  { event: "EARNED", key: "UNBILLED", account: "1221" },
  { event: "EARNED", key: "GOODS", account: "4130" },
  { event: "EARNED", key: "SERVICE", account: "4120" },
  { event: "COST_RELEASE", key: "DELIVERED", account: "5121" },
  { event: "COST_RELEASE", key: "GOODS", account: "1214" },
  { event: "RECEIPT", key: "RECEIVABLE", account: "1220" },
  { event: "RECEIPT", key: "BANK", account: "1242" },
  { event: "RECEIPT", key: "ADVANCE", account: "2160" },
  { event: "RECEIPT", key: "VDS", account: "1234" },
  { event: "RECEIPT", key: "AIT", account: "1235" },
  { event: "CUSTOMER_CREDIT", key: "RECEIVABLE", account: "1220" },
  { event: "CUSTOMER_CREDIT", key: "UNEARNED", account: "2170" },
  { event: "CUSTOMER_CREDIT", key: "GOODS", account: "4130" },
  { event: "CUSTOMER_CREDIT", key: "SERVICE", account: "4120" },
  { event: "CUSTOMER_CREDIT", key: "VAT", account: "2150" },
  { event: "FX", key: "LOSS", account: "5320" },
  { event: "FX", key: "GAIN", account: "4220" },
]
export const REQUIRED_KEYS: Record<PostingEvent, string[]> = {
  ...
  // Receivables & payables, Phase 1: mirrors exactly the keys seeded above,
  // so the posting-rules completeness screen protects this coverage from
  // the moment Phase 2/3 gives these events a caller.
  SUPPLIER_BILL: ["GOODS", "SERVICE", "VAT", "PAYABLE"],
  SUPPLIER_PAYMENT: ["PAYABLE", "BANK", "ADVANCE"],
  SUPPLIER_CREDIT: ["PAYABLE", "GOODS", "DELIVERED", "SERVICE", "VAT"],
  INVOICE: ["RECEIVABLE", "VAT", "UNBILLED", "UNEARNED"],
  EARNED: ["UNEARNED", "UNBILLED", "GOODS", "SERVICE"],
  COST_RELEASE: ["DELIVERED", "GOODS"],
  RECEIPT: ["RECEIVABLE", "BANK", "ADVANCE", "VDS", "AIT"],
  CUSTOMER_CREDIT: ["RECEIVABLE", "UNEARNED", "GOODS", "SERVICE", "VAT"],
  FX: ["LOSS", "GAIN"],
}
