...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Deliveries & acceptances", href: "/admin/accounting/deliveries", icon: "RiTruckLine" },
      { label: "Monthly earnings", href: "/admin/accounting/monthly-earnings", icon: "RiCalendarCheckLine" },
